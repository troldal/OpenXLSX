...
std::string Impl::XLDocument::executeQuery(const XLQuery& query) const
{
...
const Impl::XLXmlData* Impl::XLDocument::getXmlData(const string& path) const
{
    auto result = std::find_if(m_data.begin(), m_data.end(), [&](const XLXmlData& item) { return item.getXmlPath() == path; });
 ...
 * @details
 */
std::string Impl::XLDocument::getXmlDataFromArchive(const std::string& path)
{
...
void Impl::XLDocument::addSheetMetaData(Impl::XLCommand command)
{
...
void Impl::XLDocument::addWorksheet(Impl::XLCommand command)
{
...
void Impl::XLDocument::deleteSheet(Impl::XLCommand command)
{
