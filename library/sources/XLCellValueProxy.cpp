...
void XLCellValueProxy::setInteger(int64_t numberValue) {m_cell->setInteger(numberValue);}
void XLCellValueProxy::setBoolean(bool numberValue) {m_cell->setBoolean(numberValue);}
void XLCellValueProxy::setFloat(double numberValue) {m_cell->setFloat(numberValue);}
void XLCellValueProxy::setString(const char* stringValue) {m_cell->setString(stringValue);}
XLCellValue XLCellValueProxy::getValue() const {return m_cell->getValue();}
