#ifndef OPENXLSX_DEMO8_HPP
#define OPENXLSX_DEMO8_HPP
...
int demo8()
{
    ...
    // could be assigned to an XLRow object, to populate the data to the cells in that row.
    // In fact, this can be done with any container supporting bidirectional iterators, holding
    ...
    cout << "\nDEMO PROGRAM #08 COMPLETED\n\n";

    return 0;
}


#endif    // OPENXLSX_DEMO8_HPP
